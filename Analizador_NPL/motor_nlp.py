    ...
    def aplicar_formato_excel(archivo):
        try:
            ...
            for sheet in wb.sheetnames:
                ...
                # 📊 NUEVO: Gráficos automáticos
                if ws.max_row > 1:
                    if sheet == "Resumen Total":
                        # Gráfico circular (PieChart) para ver las proporciones de Sustantivos/Verbos
                        chart = PieChart()
                        ...
                        # Gráfico de Barras Top 10 para las pestañas individuales
...
class OrquestadorApp:
    def __init__(self):
        self.archivos = GestorArchivos(); self.nlp = ProcesadorNLP(); self.reportes = GeneradorReportes()

    def procesar_corpus(self, r_fav, r_con, nom_fav, nom_con, nom_comb, uid):
        # Aseguramos extensiones .xlsx
